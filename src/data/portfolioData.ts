...
export const PROJECTS: Project[] = [
  ...
  { id: "examly-online-examination", number: "09", title: "Examly Online Examination System", tagline: "Secure online assessment platform for modern examinations", description: "An examination workflow for student registration, timed tests, question navigation, automated submission, and result analytics.", fullStory: "Examly brings the complete assessment lifecycle into one focused experience, from exam creation and scheduled access to student attempts and performance reporting.", category: "EdTech Platform", year: "2025", tags: ["React", "Node.js", "MongoDB", "Authentication"], features: ["Timed online examinations", "Question navigation and autosave", "Student and admin dashboards", "Automated result calculation", "Performance analytics"], technologies: ["React", "Node.js", "Express", "MongoDB", "REST API"], githubUrl: "https://github.com/Nitinsaini-star/Examly-Online-Examination-System", color: "#22d3ee", accent: "rgba(34, 211, 238, 0.15)" },
  { id: "markethub-multi-vendor", number: "10", title: "MarketHub Multi-Vendor Marketplace", tagline: "Multi-seller commerce platform with storefronts and unified checkout", description: "A marketplace that lets independent sellers manage catalogs while customers discover products, compare listings, and place orders.", fullStory: "MarketHub explores marketplace operations through seller onboarding, product catalogs, inventory visibility, shopping flows, and centralized order management.", category: "Marketplace & E-Commerce", year: "2025", tags: ["MERN Stack", "Multi-Vendor", "JWT Auth", "Tailwind CSS"], features: ["Seller storefront management", "Product and inventory controls", "Customer search and filters", "Cart and unified checkout", "Order management workflows"], technologies: ["React", "Node.js", "Express", "MongoDB", "JWT"], githubUrl: "https://github.com/Nitinsaini-star/markethub-multi-vendor-marketplace", color: "#f43f5e", accent: "rgba(244, 63, 94, 0.15)" },
  { id: "cafe-website", number: "11", title: "Cafe Website", tagline: "Warm digital presence for menus, reservations, and café discovery", description: "A responsive café experience presenting the brand story, menu highlights, location details, and clear paths to visit or reserve.", fullStory: "Designed to make a local café feel welcoming before a customer arrives, combining expressive visual presentation with practical menu and contact flows.", category: "Brand & Hospitality Website", year: "2024", tags: ["React", "JavaScript", "Responsive UI", "CSS"], features: ["Responsive café landing page", "Menu and category presentation", "Reservation call-to-action", "Location and contact details", "Mobile-first visual layout"], technologies: ["React", "JavaScript", "CSS", "HTML"], githubUrl: "https://github.com/Nitinsaini-star/cafe-website", color: "#f97316", accent: "rgba(249, 115, 22, 0.15)" },
  { id: "driveease-car-rental", number: "12", title: "DriveEase Car Rental", tagline: "Simple vehicle discovery and rental booking experience", description: "A car rental interface for browsing available vehicles, selecting dates and locations, reviewing vehicle details, and starting a booking.", fullStory: "DriveEase focuses on reducing friction in short-term vehicle rental with clear availability states, vehicle comparison, rental details, and a direct booking path.", category: "Travel & Mobility Platform", year: "2024", tags: ["React", "Node.js", "MongoDB", "Booking Flow"], features: ["Vehicle search and availability", "Date and location selection", "Car detail cards", "Rental booking flow", "Responsive mobile experience"], technologies: ["React", "Node.js", "Express", "MongoDB"], githubUrl: "https://github.com/Nitinsaini-star/driveease-car-rental", color: "#38bdf8", accent: "rgba(56, 189, 248, 0.15)" },
];
